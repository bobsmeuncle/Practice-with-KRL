	...
	global {
		stockmessage = function() {
              ...
              {"s" : "%40%5EDJI,fb",
               ...
               re = (fbstock < 38) => "Fail! Facebook's latest stock price of #{fbstock} dollars is still below it's IPO price!" | "Awesome! Facebook's latest stock price of #{fbstock} dollars is above it's IPO price!";
               re
            };
	}
